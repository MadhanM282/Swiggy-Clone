  ...
  return (
    <Box>
      <h1>
        ...
        <Span1>
          <img
            src="https://img.icons8.com/ios/344/ffffff/place-marker--v1.png"
            alt=""
            width="25px"
          />
        </Span1>
      ...
      <Box
        sx={[
          { p: 2, borderRadius: 1, width: "50%", typography: "body2" },
          () => ({ "&:hover": { boxShadow: 3 } }),
        ]}
      >
        <p>
          19-27-4/3 Lig-245, Vuda Phase-2, <br /> Gandhi Nagar, Ramachandra
          Nagar, <br /> Pedagantyada, Visakhapatnam,
          <br /> Andhra Pradesh 53...
        </p>
        <h5>30 MINS</h5>
